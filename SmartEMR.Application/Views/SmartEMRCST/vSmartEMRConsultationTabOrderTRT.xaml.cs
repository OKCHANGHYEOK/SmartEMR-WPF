...
/// <summary>
/// vSmartEMRConsultationTabOrderTRT.xaml에 대한 상호 작용 논리
/// </summary>
public partial class vSmartEMRConsultationTabOrderTRT : ModelViewLayout<OrderViewModel>
{
    public vSmartEMRConsultationTabOrderTRT() { }

    protected override void Initialize()
    {
        vm.SetOrderType(OrderType.TRT);
    }
