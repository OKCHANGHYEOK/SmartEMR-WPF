...
public class ORDInsuranceTypeToBackgroundConverter : BaseConverter
{
    public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        return ORD_InsuranceType == "INS" ? SmartBrush.SMART_BRUSH_ORD_INSURANCE_INS_BACK : SmartBrush.SMART_BRUSH_ORD_INSURANCE_NON_BACK;
    }
